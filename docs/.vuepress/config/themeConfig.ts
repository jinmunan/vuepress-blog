...
export default <VdoingThemeConfig>({
    ...
    //*** 以下配置是V doing主题改动和新增的配置 ***//
    category: true, // 是否打开分类功能，默认true
    tag: true, // 是否打开标签功能，默认true
    archive: true, // 是否打开归档功能，默认true
    categoryText: "随笔", // 碎片化文章（_posts文件夹的文章）预设生成的分类值，默认'随笔'
    pageStyle: 'line', // 页面风格，card 时背景显示灰色衬托出卡片样式，line 时背景显示纯色，并且部分模块带线条边框（未设置 bodyBgImg 时才生效），默认 card
        ...
        icons: [
            {
                ...
                title: "GitHub",
                link: "https://github.com/jinmunan",
            },
            {
                iconClass: "icon-gitee",
                title: "Gitee",
                link: "https://gitee.com/jinmunan",
            },
            {
                iconClass: "icon-rss",
                title: "网站首页",
                link: "https://www.klrss.com",
            },
        ],
    },
    footer,
